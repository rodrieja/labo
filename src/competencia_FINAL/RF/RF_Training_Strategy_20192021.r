...
# Poner sus semillas
semillas <- c(481721, 483757, 503609, 519427, 539573)

#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS_RF_00_TRAINING_201901-202105"

PARAM$exp_input  <- "RF_FE9250"

PARAM$future       <- c( 202109 )

#[201901, 202105]

PARAM$final_train  <- c( 201905,201906,201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
PARAM$train$semilla_sampling  <- 519427
PARAM$train$semilla_under     <- 519427
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset_lags2_tendencia3_RF.csv.gz" )
