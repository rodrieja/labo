...
PARAM$finalmodel$learning_rate     <- 0.002938342704
PARAM$finalmodel$num_iterations    <- 902
PARAM$finalmodel$num_leaves        <- 1863
PARAM$finalmodel$min_data_in_leaf  <- 101
PARAM$finalmodel$feature_fraction  <- 0.9435814041
