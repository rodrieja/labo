...
PARAM$finalmodel$learning_rate     <- 0.009737766374
PARAM$finalmodel$num_iterations    <- 375
PARAM$finalmodel$num_leaves        <- 332
PARAM$finalmodel$min_data_in_leaf  <- 727
PARAM$finalmodel$feature_fraction  <- 0.70728155
PARAM$finalmodel$semilla           <- 519427
...
# Ajuste de datos, según en análisis realizado en el desplazamiento de las fechas de cierre.
