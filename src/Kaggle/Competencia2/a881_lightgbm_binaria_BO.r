...
PARAM$trainingstrategy$semilla_azar   <- 539573  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 519427  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
