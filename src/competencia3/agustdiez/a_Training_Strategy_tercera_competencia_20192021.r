...
PARAM  <- list()
PARAM$experimento <- "AD_TS9320_TRAINING20192021"

PARAM$exp_input  <- "AD_FE9250"

PARAM$future       <- c( 202109 )

#[201901, 202105]

PARAM$final_train  <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103 )
